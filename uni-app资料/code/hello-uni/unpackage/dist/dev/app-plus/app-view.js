...
Z(z[10])
Z(z[7])
Z([3,'http://destiny001.gitee.io/image/cxk.gif'])
Z([3,'aspectFit'])
Z(z[16])
Z([3,'aspectFill'])
Z(z[16])
...
Z([a,[[2,'+'],[1,'你好'],[1,'世界']]])
Z([a,[[2,'+'],[1,1],[1,1]]])
Z([a,[[2,'?:'],[[7],[3,'flag']],[1,'这是反话-我是假的'],[1,'这是反话-我是真的']]])
Z([[7],[3,'imgUrl']])
Z([3,'index'])
Z([3,'item'])
Z([[7],[3,'arr']])
Z([3,'id'])
Z([a,[[2,'+'],[[2,'+'],[[2,'+'],[[2,'+'],[[2,'+'],[[2,'+'],[1,'序号：'],[[7],[3,'index']]],[1,'，名字：']],[[6],[[7],[3,'item']],[3,'name']]],[1,'，年龄: ']],[[6],[[7],[3,'item']],[3,'age']]],[1,'']]])
Z([3,'__e'])
Z([[4],[[5],[[4],[[5],[[5],[1,'tap']],[[4],[[5],[[4],[[5],[[5],[1,'clickHandle']],[[4],[[5],[[5],[1,20]],[1,'$event']]]]]]]]]]])
Z([3,'primary'])
Z([3,'按钮'])
...
(function(z){var a=11;function Z(ops){z.push(ops)}
Z([3,'__e'])
Z([[4],[[5],[[4],[[5],[[5],[1,'tap']],[[4],[[5],[[4],[[5],[[5],[1,'get']],[[4],[[5],[1,'$event']]]]]]]]]]])
Z([3,'发送get请求'])
Z([3,'这是列表页'])
Z([3,'__i0__'])
Z([3,'item'])
...
var x=['./pages/contact/contact.wxml','./pages/detail/detail.wxml','./pages/home/home.wxml','./pages/index/index.wxml','./pages/list/list.wxml','./pages/message/message.wxml','./pages/uni-style/uni-style.wxml'];d_[x[0]]={}
...
var hG=_mz(z,'view',['hoverStopPropagation',-1,'class',2,'hoverClass',1,'hoverStartTime',2,'hoverStayTime',3],[],e,s,gg)
...
_(fE,cI)
var lK=_n('button')
_rz(z,lK,'size',8,e,s,gg)
var aL=_oz(z,9,e,s,gg)
_(lK,aL)
_(fE,lK)
var tM=_n('button')
_rz(z,tM,'type',10,e,s,gg)
var eN=_oz(z,11,e,s,gg)
_(tM,eN)
_(fE,tM)
var bO=_mz(z,'button',['plain',-1,'type',12],[],e,s,gg)
var oP=_oz(z,13,e,s,gg)
_(bO,oP)
_(fE,bO)
var xQ=_mz(z,'button',['disabled',-1,'type',14],[],e,s,gg)
var oR=_oz(z,15,e,s,gg)
_(xQ,oR)
_(fE,xQ)
var fS=_n('button')
fS.attr['loading']=true
_(fE,fS)
var cT=_n('image')
_rz(z,cT,'src',16,e,s,gg)
_(fE,cT)
var hU=_mz(z,'image',['mode',17,'src',1],[],e,s,gg)
_(fE,hU)
var oV=_mz(z,'image',['mode',19,'src',1],[],e,s,gg)
_(fE,oV)
_(r,fE)
return r
}
...
_(oX,f7)
var h9=_n('image')
_rz(z,h9,'src',5,e,s,gg)
_(oX,h9)
var o0=_v()
_(oX,o0)
var cAB=function(lCB,oBB,aDB,gg){
var eFB=_n('view')
var bGB=_oz(z,10,lCB,oBB,gg)
_(eFB,bGB)
_(aDB,eFB)
return aDB
}
o0.wxXCkey=2
_2z(z,8,cAB,e,s,gg,o0,'item','index','id')
var oHB=_mz(z,'button',['bindtap',11,'data-event-opts',1,'type',2],[],e,s,gg)
...
var cLB=_mz(z,'image',['class',1,'src',1],[],e,s,gg)
_(fKB,cLB)
var hMB=_n('view')
...
var z=gz$gwx_5()
var lQB=_n('view')
var aRB=_mz(z,'button',['bindtap',0,'data-event-opts',1],[],e,s,gg)
...
var o2B=_n('view')
_rz(z,o2B,'class',7,fYB,oXB,gg)
var c3B=_oz(z,8,fYB,oXB,gg)
_(o2B,c3B)
_(cZB,o2B)
return cZB
}
oVB.wxXCkey=2
_2z(z,6,xWB,e,s,gg,oVB,'item','__i0__','')
_(r,lQB)
return r
}
...
__wxAppCode__['pages/list/list.wxss']=setCssToHead([".",[1],"box-item{ height: 100px; line-height: 100px; }\n",],undefined,{path:"./pages/list/list.wxss"});    
...
__wxAppCode__['pages/uni-style/uni-style.wxss']=setCssToHead(["@charset \x22UTF-8\x22;\nwx-view{ color: green; }\n.",[1],"box1 { width: ",[0,375],"; height: ",[0,375],"; background: red; font-size: ",[0,30],"; color: #fff; }\n.",[1],"box1 wx-text { color: pink; }\n",],undefined,{path:"./pages/uni-style/uni-style.wxss"});    
__wxAppCode__['pages/uni-style/uni-style.wxml']=$gwx('./pages/uni-style/uni-style.wxml');
